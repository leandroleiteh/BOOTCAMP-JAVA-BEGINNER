...
public class Bootcamp {
	...
	public void setDevsInscirtos(Set<Dev> devsInscirtos) {
		this.devsInscirtos = devsInscirtos;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, descricao, devsInscirtos, nome);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				...
				&& Objects.equals(devsInscirtos, other.devsInscirtos) && Objects.equals(nome, other.nome);
	}
